...
class CandleDownloader:
    def __init__(self, exchange_name='binance', pair_name='BTC/USDT', timeframe='15m', start_time='2015-01-01T00:00:00Z', end_time=None, batch_size=1000, output_file=None):
